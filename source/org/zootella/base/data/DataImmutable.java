...
public class DataImmutable implements Comparable<DataImmutable> {

	// Make
	
	/** Make a new Data object that views the single byte y. */
	public DataImmutable(byte y) { this(Convert.toByteBuffer(y)); }
	/** Make a new Data object that views the given byte array. */
	public DataImmutable(byte[] a) { this(Convert.toByteBuffer(a)); }
	/** Make a new Data object that views the data of the given String. */
	public DataImmutable(String s) { this(Convert.toByteBuffer(s)); }
	/** Make a new Data object that views the data between b's position and limit, doesn't change b. */
	public DataImmutable(ByteBuffer b) {
	 ...
	 */
	//TODO delete, just copy the reference because it's immutable
	public Data copy() {
	...
	public DataImmutable(long n) { this(Number.toString(n)); }
	/** Make a new Data object that holds b as the text "t" or "f". */
	public DataImmutable(boolean b) { this(b ? "t" : "f"); }
	...
	public DataImmutable(BigInteger b) {
		this(b.toByteArray());
	}
	...
	//TODO needs to return a new data that's smaller
	...
	//TODO return the new different data
	...
	//TODO this one changes this data and returns a new one, you can't do this anymore
	 ...
	 */
	//TODO for simplicity, always have the buffer position at 0 when you make the other changes here
	private final ByteBuffer buffer;

	// Clip
	//TODO the ones in this section are already immutable, just switch all your code to use them instead of the bad ones
	...
	@Override public int compareTo(DataImmutable d) {
