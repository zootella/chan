...
public class Guide {
	...
	public static final String icon = "org/zootella/main/resource/icon.gif";
	...
	public static final Dimension sizeInfoFrame = new Dimension(1000, 500);
	public static final Dimension sizeHashFrame = new Dimension(1000, 200);
